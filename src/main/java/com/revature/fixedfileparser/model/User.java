...
public class User {
    ...
    /**
     * When posting a new user, id can be generated by the database
     *
     * @param user_id the id associated with a user
     ...
     */
    public User(ObjectId user_id, String username, String password, String role) {
